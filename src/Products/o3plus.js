...
const O3plus = ({ showFilters = true, limit, addToCart }) => {
...
useEffect(() => {
axios
.get("http://localhost:3001/fetchProductslisto3plusShirt")
.then((response) => {
...
if (query) {
axios
.get("http://localhost:3001/fetchProductslisto3plus", {
params: { search: query },
})
.then((response) => {
...
export default connect(null, { addToCart })(O3plus);